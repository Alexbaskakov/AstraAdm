...
3. **Настройка клавиатуры и сети**:
   ...
   - Укажите имя компьютера, например: `astra-lab1`.

4. **Настройка учетных записей**:
   - Создайте администратора: имя `admin`, пароль (сложный, не менее 8 символов).
...
6. **Выбор ПО и настроек**:
   - Установите "Консольные утилиты" и "Средства удаленного подключения SSH".
   - Выберите базовый уровень защищенности "Орёл".
   - Включите мандатный контроль, замкнутую среду, запрет ptrace.
