...
# Практическая часть
1. Написать и протестировать скрипт резервного копирования (для отдельной папки, не нужно копировать весь диск).
3. Настроить его автоматический запуск через: cron или systemd-timer
...
6. Запустить Playbook для обновления пакетов на нескольких узлах. (Сделать клон ВМ или делать в парах - решать Вам)
